"""
Django settings for liga_lokal project.
...
SECRET_KEY = 'django-insecure-&c8r$v49k52_x#q7^$o&&5-fvd+er*b1fvayxu-)(5lllddk+0'
...
WSGI_APPLICATION = 'liga_lokal.wsgi.application'
